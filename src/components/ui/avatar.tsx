...
const AvatarFallback = ({ className, ...props }: React.ComponentProps<typeof AvatarPrimitive.Fallback>) => (
  <AvatarPrimitive.Fallback className={cn("flex h-full w-full items-center justify-center rounded-xl bg-blue-50 text-blue-600 text-sm font-semibold", className)} {...props} />
);
